...
import { updateSilkSpool, SilkSpoolState } from '@/app/lib/actions';
import { useActionState } from 'react';
import { SilkSpoolForm } from '@/app/lib/definitions';

export default function EditSilkSpoolForm({ spool }: { spool: SilkSpoolForm }) {
  const initialState: SilkSpoolState = { message: null, errors: {} };
  const updateSilkSpoolWithId = updateSilkSpool.bind(null, spool.id);
  const [state, formAction] = useActionState(updateSilkSpoolWithId, initialState);
  ...
  return (
    <form action={formAction}>
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            <input
              ...
              placeholder="Enter silk spool name"
            ...
            <div className="flex gap-4">
              <div className="flex items-center">
                <input
                  ...
                  type="radio"
                  value="pending"
                  defaultChecked={spool.status === 'pending'}
              ...
              <div className="flex items-center">
                <input
                  ...
                  type="radio"
                  value="collected"
                  defaultChecked={spool.status === 'collected'}
      ...
      <div className="mt-6 flex justify-end gap-4">
        ...
        <Button type="submit">Update Silk Spool</Button>
      </div>
    </form>
  );
}
