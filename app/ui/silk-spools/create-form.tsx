...
import { createSilkSpool, SilkSpoolState } from '@/app/lib/actions';
import { useActionState } from 'react';

export default function Form() {
  const initialState: SilkSpoolState = { message: null, errors: {} };
  const [state, formAction] = useActionState(createSilkSpool, initialState);
  ...
  return (
    <form action={formAction}>
      ...
      <div className="mt-6 flex justify-end gap-4">
        ...
        <Button type="submit">Create Silk Spool</Button>
      </div>
    </form>
  );
}
