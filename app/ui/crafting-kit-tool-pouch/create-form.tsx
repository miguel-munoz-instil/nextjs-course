...
import { createCraftingKitToolPouch, CraftingKitToolPouchState } from '@/app/lib/actions';
import { useActionState } from 'react';
import { WrenchScrewdriverIcon } from '@heroicons/react/24/outline';

export default function Form() {
  const initialState: CraftingKitToolPouchState = { message: null, errors: {} };
  const [state, formAction] = useActionState(createCraftingKitToolPouch, initialState);
