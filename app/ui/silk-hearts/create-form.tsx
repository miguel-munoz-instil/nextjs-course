...
import { createSilkHeart, SilkHeartState } from '@/app/lib/actions';
import { useActionState } from 'react';
import { HeartIcon } from '@heroicons/react/24/outline';

export default function Form() {
  const initialState: SilkHeartState = { message: null, errors: {} };
  const [state, formAction] = useActionState(createSilkHeart, initialState);
  ...
  return (
    <form action={formAction}>
      ...
      <div className="mt-6 flex justify-end gap-4">
        ...
        <Button type="submit">Create Silk Heart</Button>
      </div>
    </form>
  );
}
