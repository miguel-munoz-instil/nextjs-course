...
import { updateSilkHeart, SilkHeartState } from '@/app/lib/actions';
import { useActionState } from 'react';
import { SilkHeartForm } from '@/app/lib/definitions';
import { HeartIcon } from '@heroicons/react/24/outline';

export default function EditSilkHeartForm({ heart }: { heart: SilkHeartForm }) {
  const initialState: SilkHeartState = { message: null, errors: {} };
  const updateSilkHeartWithId = updateSilkHeart.bind(null, heart.id);
  const [state, formAction] = useActionState(updateSilkHeartWithId, initialState);
  ...
  return (
    <form action={formAction}>
      <div className="rounded-md bg-void-black border border-thorny-purple p-4 md:p-6">
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            <input
              ...
              name="name"
              type="text"
              defaultValue={heart.name}
              placeholder="Enter silk heart name"
            ...
            />
            <HeartIcon className="pointer-events-none absolute left-3 top-1/2 h-[18px] w-[18px] -translate-y-1/2 text-silk-silver peer-focus:text-thorny-purple" />
          </div>
            ...
            <div className="flex gap-4">
              <div className="flex items-center">
                <input
                  ...
                  type="radio"
                  value="pending"
                  defaultChecked={heart.status === 'pending'}
              ...
              <div className="flex items-center">
                <input
                  ...
                  type="radio"
                  value="collected"
                  defaultChecked={heart.status === 'collected'}
                  className="h-4 w-4 cursor-pointer border-silk-silver bg-void-black text-thorny-purple focus:ring-2 focus:ring-thorny-purple"
                  aria-describedby="status-error"
                />
                <label
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            <textarea
              ...
              name="notes"
              rows={4}
              defaultValue={heart.notes}
              placeholder="Enter notes about this silk heart"
        ...
        <input type="hidden" name="percentage" value={heart.percentage} />
      ...
      <div className="mt-6 flex justify-end gap-4">
        ...
        <Button type="submit">Edit Silk Heart</Button>
      </div>
    </form>
  );
}
