...
import { createCrest, CrestState } from '@/app/lib/actions';
import { useActionState } from 'react';
import { ShieldCheckIcon } from '@heroicons/react/24/outline';

export default function Form() {
  const initialState: CrestState = { message: null, errors: {} };
  const [state, formAction] = useActionState(createCrest, initialState);
  ...
  return (
    <form action={formAction}>
      ...
      <div className="mt-6 flex justify-end gap-4">
        ...
        <Button type="submit">Create Crest</Button>
      </div>
    </form>
  );
}
