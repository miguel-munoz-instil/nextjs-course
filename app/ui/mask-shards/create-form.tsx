...
import { createMaskShard, MaskShardState } from '@/app/lib/actions';
import { useActionState } from 'react';

export default function Form() {
  const initialState: MaskShardState = { message: null, errors: {} };
  const [state, formAction] = useActionState(createMaskShard, initialState);
  ...
  return (
    <form action={formAction}>
      ...
      <div className="mt-6 flex justify-end gap-4">
        ...
        <Button type="submit">Create Mask Shard</Button>
      </div>
    </form>
  );
}
