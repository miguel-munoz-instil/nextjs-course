...
import { updateMaskShard, MaskShardState } from '@/app/lib/actions';
import { useActionState } from 'react';
import { MaskShardForm } from '@/app/lib/definitions';

export default function EditMaskShardForm({ shard }: { shard: MaskShardForm }) {
  const initialState: MaskShardState = { message: null, errors: {} };
  const updateMaskShardWithId = updateMaskShard.bind(null, shard.id);
  const [state, formAction] = useActionState(updateMaskShardWithId, initialState);
  ...
  return (
    <form action={formAction}>
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            <input
              ...
              placeholder="Enter mask shard name"
            ...
            <div className="flex gap-4">
              <div className="flex items-center">
                <input
                  ...
                  type="radio"
                  value="pending"
                  defaultChecked={shard.status === 'pending'}
              ...
              <div className="flex items-center">
                <input
                  ...
                  type="radio"
                  value="collected"
                  defaultChecked={shard.status === 'collected'}
      ...
      <div className="mt-6 flex justify-end gap-4">
        ...
        <Button type="submit">Update Mask Shard</Button>
      </div>
    </form>
  );
}
